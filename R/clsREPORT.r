...
setMethod("setREPORT", signature = (object = "REPORT"), function(object) {
	...
	if(object@blnOverwriteReport & file.exists(fileReport)) file.remove(fileReport)
	i = 1
...
setMethod("REPORT.addval", signature(obj1 = "REPORT", obj2 = "character",obj3="logical"), function(obj1,obj2,obj3, ...) {
...
setMethod("REPORT.setval", signature(obj1 = "REPORT", obj2 = "character",obj3="character"), function(obj1,obj2,obj3, ...) {
	...
	if(is.na(iCol)) {
		stop(paste(" EASY ERROR:REPORT\n Cannot find ",strValName,"in REPORT !", sep=""))
	}
...
setMethod("REPORT.setval", signature(obj1 = "REPORT", obj2 = "character",obj3="logical"), function(obj1,obj2,obj3, ...) {
...
REPORT <- function(fileOutBody, blnOverwriteResults){ 
	## Wrapper for class definition
	#REPORTout <- setREPORT(new("REPORT", fileReport = paste(objECF@pathOut,objECF@aSetTags[iSet],".EASY.REPORT.txt",sep="")))
	REPORTout <- setREPORT(new("REPORT", fileReportBody = fileOutBody, blnOverwriteReport = blnOverwriteResults))
	return(REPORTout)
